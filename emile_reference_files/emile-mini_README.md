...
**Empirical Semiotics** Examines how meaning emerges from living-like processes rather than symbolic manipulation. The system demonstrates:
...
- [Research Results & Preliminary Findings](#-research-results-&-preliminary-findings)
...
```
2. **Embodied QSE:** Sensorimotor integration where surplus (information) fields couple perception and action  
```
...
## 📊 Research Results & Preliminary Findings
...
> Decisions exhibit a refractory structure with first nonzero hazard at delay 14. Event-triggered
averages reveal small but consistent pre-decision drifts: tau_prime trends downward into the event
and surplus_mean dips around −7 then rebounds toward baseline. Information-theoretic analysis
confirms both variables predict decisions across runs (TE with 95% CIs excluding 0): surplus_mean:
0.004705 [0.003568, 0.005843]; tau_prime: 0.001750 [0.001239, 0.002261]. Paired surplus_mean -
tau_prime: mean diff=0.002955 (95% CI [0.001917, 0.003994]).
...
- *(Optional, for PPO baseline)* gymnasium ≥ 0.28, stable-baselines3 ≥ 2.0.0
...
git clone --depth 1 --branch v0.5.1 https://github.com/Baglecake/emile-mini.git
cd emile-mini
python -m pip install -e .
```
...
* ✅ **Enhanced Navigation System** (v0.5.1)
* ✅ **Cognitive Battery Runner** (v0.5.1)  
* ✅ **Multimodal Integration** (v0.5.1)
